...
Transmiter::Transmiter(int port_to_transmit_video, int port_to_transmit_audio){
    this->port_for_audio = port_to_transmit_audio;
    this->port_for_video = port_to_transmit_video;
}
